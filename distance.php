...
<a href='voirLesOffres.php'><input type='submit' class='bouton' value='Ne pas trier les offres par distance'></a><br/>
...
<?php
    ...
    $reponse = $bdd -> query("SELECT o.numOffer numOffer, o.picture picture_offer, o.price price_offer, o.priceType priceType_offer, o.qty quantity_offer, o.qtyType quantityType_offer, 
      ...
      o.troc troc_offer, o.season saison_offer,  o.distance distance, v.name variete_offer, v.category category_fruit, m.memberType memberType, m.pseudo member_offer FROM offer o INNER JOIN variety v ON 
      v.idVariety = o.Variety_idVariety INNER JOIN member m ON m.idMember = o.Member_idMember ORDER BY distance");
