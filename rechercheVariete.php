...
echo "<br/><div class='offre'>
      ...
      if(isset($_SESSION['pseudo']) AND $donnees['member_offer'] != $_SESSION['pseudo']) {
          ...
          echo "<p><form name='selectionOffre' action='selectionOffre_post?variable=$i.php' method='post' accept-charset='utf-8'>
